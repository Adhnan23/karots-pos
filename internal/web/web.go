...
func RegisterUI(e *echo.Echo, db *sqlx.DB, cfg *config.Config, authSvc *auth.Service) {
	...
	ag.GET("/stock/batches", admin.BatchesPage)
	ag.POST("/stock/expired/write-off-all", admin.WriteOffExpired)
	...
	ag.GET("/reports/supplier-spend", admin.SupplierSpendReport)
